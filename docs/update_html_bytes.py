...
social_links_old = b"""<div class="footer-socials">
...
social_links_new = b"""<div class="footer-socials">
...
for filename in html_files:
    ...
    content = content.replace(b'\xc3\xa2\xe2\x80\xa0\xe2\x80\x99', b'&rarr;') # if encoded as utf-8 but originally windows-1252
    content = content.replace(b'\xe2\x86\x92', b'&rarr;')
    
    with open(filename, 'wb') as f:
        f.write(content)

print("Python bytes script complete")
